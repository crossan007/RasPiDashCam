...
def putFrames():
    ...
    command2 = "/usr/bin/avconv -f rawvideo -pix_fmt rgb24 -video_size 640x480 -r 15 -i pipe: -vf \"setpts=0.1*PTS\" -c:v mpeg2video -map 0 -f mp4 -f segment -segment_time 90 \"vid-"+date+"-%03d.mp4\""
